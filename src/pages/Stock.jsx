            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Manage your ingredient inventory and track purchases</p>
                </div>
              </div>
              <Button 
                onClick={() => { 
                ...
                className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white shadow-lg hover:shadow-xl transition-all duration-200 px-6 py-2.5"
              >
